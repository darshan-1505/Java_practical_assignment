...
public class pr11 
{
    ...
    {
        Triplet<String, Integer, Character> p1 = Triplet.of("DARSHAN CHAVDA", 19, 'M');
        Triplet<String, Integer, Character> p2 = Triplet.of("KEVAL", 38, 'M');
        Triplet<String, Integer, Character> p3 = Triplet.of("OMDUTT", 17, 'M');
